...
public class JDTelaCadForn extends JDialog implements ActionListener{
	...
	public JDTelaCadForn() throws ParseException {
		...
		((JFormattedTextField) JFFRg).setFocusLostBehavior(JFormattedTextField.COMMIT); // Permite o usuÃ¡rio avanÃ§ar o campo sem preencher todos a mÃ¡scara
	...
	public void actionPerformed(ActionEvent acao) {
		...
		if(acao.getSource() == JBSalvForn){
			...
			if(JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null, "Deseja cadastrar o fornecedor?")){
		...
		if(acao.getSource() == JBNovForn){
			...
			if(JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null, "Deseja cadastrar um novo fornecedor?")){
