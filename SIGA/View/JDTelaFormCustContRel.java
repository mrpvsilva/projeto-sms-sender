...
public class JDTelaFormCustContRel extends JDialog implements ActionListener{
	...
	public static void main(String[] args) {
		try {
			JDTelaFormCustContRel dialog = new JDTelaFormCustContRel();
	 ...
	 * Create the dialog.
	 */
	public JDTelaFormCustContRel() {
		setResizable(false);
		setModal(true);
		setTitle("SIGA - Sistema de informa\u00E7\u00E3o G&A - relatório contrato formatura customizado");
