...
public class JDTelaOrcImpRel extends JDialog implements ActionListener{
	...
	public static void main(String[] args) {
		try {
			JDTelaOrcImpRel dialog = new JDTelaOrcImpRel();
	 ...
	 * Create the dialog.
	 */
	public JDTelaOrcImpRel() {
		setTitle("SIGA - Sistema de informa\u00E7\u00E3o G&A - impressão de orçamento");
