...
public class JDTelaSincFin extends JDialog implements ActionListener{
	...
	public static void main(String[] args) {
		try {
			JDTelaSincFin dialog = new JDTelaSincFin();
	 ...
	 * Create the dialog.
	 */
	public JDTelaSincFin() {
		setResizable(false);
		setModal(true);
		setTitle("SIGA - Sistema de informa\u00E7\u00E3o G&A - Sincronização de pagamento");
