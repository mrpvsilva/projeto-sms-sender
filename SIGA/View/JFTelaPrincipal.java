...
public class JFTelaPrincipal extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent acao) {
		...
		if(acao.getSource() == JMIFornExcluir){
			JOptionPane.showInputDialog("Digite o código do fornecedor para exclusão");
...
/*==============================================================================================================================================*/
		...
		if(acao.getSource() == JMIServExcluir){
			JOptionPane.showInputDialog("Digite o código do serviço para exclusão");
...
/*==============================================================================================================================================*/
		...
		if(acao.getSource() == JMICliExcluir){
			JOptionPane.showInputDialog("Digite o código do cliente para exclusão");
...
/*==============================================================================================================================================*/
		...
		if(acao.getSource() == JMILembExcluir){
			JOptionPane.showInputDialog("Digite o código do lembrete para exclusão");
...
/*==============================================================================================================================================*/
		...
		if(acao.getSource() == JMIUsuExcluir){
			JOptionPane.showInputDialog("Digite o login do usuário para exclusão");
