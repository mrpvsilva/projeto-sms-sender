...
public class JDTelaSerRealEventRel extends JDialog implements ActionListener{
	...
	public static void main(String[] args) {
		try {
			JDTelaSerRealEventRel dialog = new JDTelaSerRealEventRel();
	 ...
	 * Create the dialog.
	 */
	public JDTelaSerRealEventRel() {
		setResizable(false);
		setModal(true);
		setTitle("SIGA - Sistema de informa\u00E7\u00E3o G&A - evento a ser realizado");
