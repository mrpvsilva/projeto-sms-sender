...
public class JDTelaFormCompContRel extends JDialog implements ActionListener{
	...
	public static void main(String[] args) {
		try {
			JDTelaFormCompContRel dialog = new JDTelaFormCompContRel();
	 ...
	 * Create the dialog.
	 */
	public JDTelaFormCompContRel() {
		setModal(true);
		setResizable(false);
		setTitle("SIGA - Sistema de informa\u00E7\u00E3o G&A - relatório contrato formatura completo");
